    ...
    <>
      {!inline && (
        ...
        >
          ...
          <div className={cn('flex gap-0 flex-col')}>
            <div className="text-base notion-link group-hover:notion-link-hover">{title}</div>
      ...
      {inline && (
        ...
        >
          ...
          <div
            className={cn(
              'text-base notion-link group-hover:notion-link-hover border-b border-slate-200 leading-[1.1]'
            )}
          >
            {title}
          </div>
